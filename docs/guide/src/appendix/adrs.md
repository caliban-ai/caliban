...
ADRs live in the `docs/adr/` directory of the repository. They use a lightweight [MADR-lite](https://adr.github.io/madr/) format and carry a status:
...
| # | Title | Status |
|---|---|---|
| [0000](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0000-architecture-decision-records.md) | Record architecture decisions (MADR-lite under `docs/adr/`) | accepted |
| [0001](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0001-async-runtime.md) | Async runtime → `tokio` | accepted |
| [0002](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0002-error-model.md) | Error model → `thiserror` for libs, `anyhow` for binary | accepted |
| [0003](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0003-license-agpl-3.0.md) | License → `AGPL-3.0-only` | accepted |
| [0004](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0004-naming-conventions.md) | Naming → `caliban-*` libraries, `caliban` binary | accepted |
| [0005](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0005-workspace-layout.md) | Workspace layout → `crates/` for libs, binaries at root | accepted |

### Provider & message model

| # | Title | Status |
|---|---|---|
| [0006](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0006-message-schema-ir.md) | Message schema → provider-neutral IR | accepted |
| [0007](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0007-transport-trait-pattern.md) | Schema/transport factoring via Transport trait | accepted |
| [0008](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0008-system-role-positional.md) | `Role::System` is positional (leading-only) | accepted |
...
| # | Title | Status |
|---|---|---|
| [0011](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0011-sessions-and-repl.md) | Sessions persisted to disk + interactive REPL | accepted |
| [0012](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0012-tui-via-ratatui.md) | TUI via ratatui (replacing the rustyline REPL) | accepted |
| [0013](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0013-tui-overlays.md) | TUI overlays + layout v2 | accepted |
| [0014](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0014-system-prompt-and-tui-fixes.md) | Default system prompt + TUI stall fixes + debug logging | accepted |
| [0015](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0015-context-and-path-fixes.md) | Context preservation + path conventions (~ expansion) | accepted |
| [0027](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0027-tui-ergonomics.md) | TUI ergonomics (@file, !, Ctrl+G, Ask modal, transcript viewer) | accepted |
| [0041](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0041-tui-redraw-tick-closeout.md) | TUI redraw tick — close-out (resolves 0014 open question) | accepted |

### Memory & checkpointing

| # | Title | Status |
|---|---|---|
| [0018](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0018-memory-tier-model.md) | Memory tier model (global / project / auto-memory; spliced into system prompt) | accepted |
| [0028](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0028-checkpointing-rewind.md) | Auto-checkpointing + `/rewind` | accepted |
| [0035](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0035-auto-memory.md) | Auto-memory (model-written notes per project) | accepted |
| [0036](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0036-claudemd-ancestry-and-imports.md) | CLAUDE.md ancestor walk + `@`-imports | accepted |
...
| # | Title | Status |
|---|---|---|
| [0019](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0019-skills-loading.md) | Skills loading & invocation (frontmatter + body; `SkillTool` on-demand load) | accepted |
| [0024](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0024-hook-event-taxonomy.md) | Hook event taxonomy (expanded events + handler types) | accepted |
| [0030](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0030-plugin-packaging.md) | Plugin packaging (skills + hooks + agents + MCP + output-styles bundles) | accepted |
| [0031](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0031-output-styles.md) | Output styles (Default / Proactive / Explanatory / Learning + custom) | accepted |
| [0040](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0040-slash-command-registry.md) | Slash command registry (extensible `SlashCommand` trait) | accepted |
...
| # | Title | Status |
|---|---|---|
| [0022](https://github.com/caliban-ai/caliban/blob/main/docs/adr/0022-model-routing-architecture.md) | Model routing architecture (Layer 3 `caliban-model-router`; router-impl-Provider) | accepted |
