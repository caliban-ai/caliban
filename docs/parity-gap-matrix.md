...
| Multi-line input (`\`+Enter, Option+Enter, Shift+Enter native) | ✅ | #101 — all three chords wired: native Shift+Enter (kitty keyboard-enhancement flags), Alt/Option+Enter fallback, and trailing-`\`+Enter continuation (unescaped backslash dropped, newline inserted; odd-run aware) |
| Voice dictation | 🔴 | |
