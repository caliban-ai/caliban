...
/// override (not modeled in v2's request type yet — passed in here from the
/// CLI/headless layer), or (b) the route's pinned default, or (c)
/// `EffortLevel::Medium` as a final fallback.
#[must_use]
